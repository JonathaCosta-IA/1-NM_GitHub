...
em \href{https://github.com/JonathaCosta-IA/NM/blob/main/B-NM_codes/SolListaExerciciosPropostos/z_AplicMN_eng/dados_radiacao.csv}{MatrizRadiação}}
de perfis horários médios mensais de irradiação solar global \((\mathrm{Wh/m^2})\) apresentada a seguir:
\small{
\[A =
\begin{bmatrix}
