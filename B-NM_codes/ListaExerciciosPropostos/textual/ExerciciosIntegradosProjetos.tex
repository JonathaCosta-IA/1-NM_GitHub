...
\href{https://github.com/JonathaCosta-IA/NM/blob/main/B-NM_codes/SolListaExerciciosPropostos/z_AplicMN_eng/dados_radiacao.csv}
{Matriz Completa\footnote
{O arquivo .csv com o conteúdo desta matriz está disponível em
\url{https://github.com/JonathaCosta-IA/NM/blob/main/B-NM_codes/SolListaExerciciosPropostos/z_AplicMN_eng/dados_radiacao.csv}
}
}.
